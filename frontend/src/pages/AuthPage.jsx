      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              width: '100%',
              background: loading ? '#333' : 'linear-gradient(135deg, #d4845e, #c07050)',
              ...
              transition: 'all 0.3s ease',
              boxShadow: loading ? 'none' : '0 4px 24px rgba(212,132,94,0.3)',
              letterSpacing: '0.01em',
              position: 'relative',
              overflow: 'hidden',
            }}
            onMouseEnter={e => { if (!loading) e.target.style.boxShadow = '0 6px 30px rgba(212,132,94,0.4)' }}
            onMouseLeave={e => { if (!loading) e.target.style.boxShadow = '0 4px 24px rgba(212,132,94,0.3)' }}
          >
            {loading ? (
